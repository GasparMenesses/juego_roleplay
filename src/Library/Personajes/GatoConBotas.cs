...
public class GatoConBotas : Enemy
{
    ...
    public GatoConBotas(string name)  //Ese : base(...) le dice al compilador “antes de ejecutar el cuerpo de este constructor, invoca el constructor de la clase padre (Character) pasándole estos parámetros”
    ...
    //Este valor se comparte entre todas las instancias de GatoConBotas .
